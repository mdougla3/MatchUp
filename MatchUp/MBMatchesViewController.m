...
#import "MBMatchesViewController.h"
#import "MBChatViewController.h"

@interface MBMatchesViewController () <UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) IBOutlet UITableView *tableView;
@property (strong, nonatomic) NSMutableArray *availableChatRooms;
@end

@implementation MBMatchesViewController
...
{
    MBChatViewController *chatVC = segue.destinationViewController;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = likedUser[@"pforile"][@"firstName"];
